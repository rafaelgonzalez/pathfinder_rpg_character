  ...
  module Skills
    ...
    def add_skills_classes_to_namespace
      ...
      skills_config.keys.each do |skill_name|
        unless Character::Skill.const_defined? skill_name.camelize
    ...
    def create_skill_class(skill_class_name, skill_config)
      klass = Character::Skill.const_set(skill_class_name, Class.new(Skill::Base))
    ...
    def skills_list
      ...
      list.map {|skill_name| "Character::Skill::#{skill_name}".constantize }
    end
