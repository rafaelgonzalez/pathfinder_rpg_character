...
describe PathfinderRpg::Character::Klass::Paladin do
  ...
  describe '.label' do
    it { expect(described_class.label).to eql 'paladin' }
  end

  describe '#label' do
    it { expect(subject.label).to eql 'paladin' }
  end

  describe '.available_alignments' do
    it { expect(described_class.available_alignments).to include('lawful_good') }
    it { expect(described_class.available_alignments).not_to include('neutral_good', 'chaotic_good', 'lawful_neutral', 'true_neutral', 'chaotic_neutral', 'lawful_evil', 'neutral_evil', 'chaotic_evil') }
  end

  describe '#available_alignments' do
    it { expect(subject.available_alignments).to include('lawful_good') }
    it { expect(subject.available_alignments).not_to include('neutral_good', 'chaotic_good', 'lawful_neutral', 'true_neutral', 'chaotic_neutral', 'lawful_evil', 'neutral_evil', 'chaotic_evil') }
  end
