RSpec.describe PathfinderRpg::Character::Klass::Druid do
  ...
  describe '.label' do
    it { expect(described_class.label).to eql 'druid' }
  end

  describe '#label' do
    it { expect(subject.label).to eql 'druid' }
  end

  describe '.available_alignments' do
    it { expect(described_class.available_alignments).to include('neutral_good', 'lawful_neutral', 'true_neutral', 'chaotic_neutral', 'neutral_evil') }
    it { expect(described_class.available_alignments).not_to include('lawful_good', 'chaotic_good', 'lawful_evil', 'chaotic_evil') }
  end

  describe '#available_alignments' do
    it { expect(subject.available_alignments).to include('neutral_good', 'lawful_neutral', 'true_neutral', 'chaotic_neutral', 'neutral_evil') }
    it { expect(subject.available_alignments).not_to include('lawful_good', 'chaotic_good', 'lawful_evil', 'chaotic_evil') }
  end
