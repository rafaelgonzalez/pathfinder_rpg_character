RSpec.describe PathfinderRpg::Character::Klass::Barbarian do
  ...
  describe '.label' do
    it { expect(described_class.label).to eql 'barbarian' }
  end

  describe '#label' do
    it { expect(subject.label).to eql 'barbarian' }
  end

  describe '.available_alignments' do
    it { expect(described_class.available_alignments).to include('neutral_good', 'chaotic_good', 'true_neutral', 'chaotic_neutral', 'neutral_evil', 'chaotic_evil') }
    it { expect(described_class.available_alignments).not_to include('lawful_good', 'lawful_neutral', 'lawful_evil') }
  end

  describe '#available_alignments' do
    it { expect(subject.available_alignments).to include('neutral_good', 'chaotic_good', 'true_neutral', 'chaotic_neutral', 'neutral_evil', 'chaotic_evil') }
    it { expect(subject.available_alignments).not_to include('lawful_good', 'lawful_neutral', 'lawful_evil') }
  end
  ...
  describe '.hit_die' do
    it { expect(described_class.hit_die).to eql 12 }
  end

  describe '#hit_die' do
    it { expect(subject.hit_die).to eql 12 }
  end
