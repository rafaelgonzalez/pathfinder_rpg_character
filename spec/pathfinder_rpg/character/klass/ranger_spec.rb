RSpec.describe PathfinderRpg::Character::Klass::Ranger do
  ...
  describe '.label' do
    it { expect(described_class.label).to eql 'ranger' }
  end

  describe '#label' do
    it { expect(subject.label).to eql 'ranger' }
  end

  describe '.available_alignments' do
    it { expect(described_class.available_alignments).to include('lawful_good', 'neutral_good', 'chaotic_good', 'lawful_neutral', 'true_neutral', 'chaotic_neutral', 'lawful_evil', 'neutral_evil', 'chaotic_evil') }
  end

  describe '#available_alignments' do
    it { expect(subject.available_alignments).to include('lawful_good', 'neutral_good', 'chaotic_good', 'lawful_neutral', 'true_neutral', 'chaotic_neutral', 'lawful_evil', 'neutral_evil', 'chaotic_evil') }
  end

  describe '.skill_ranks_per_level' do
    it { expect(described_class.skill_ranks_per_level).to eql 6 }
  end

  describe '#skill_ranks_per_level' do
    it { expect(subject.skill_ranks_per_level).to eql 6 }
  end
  ...
  describe '#skills_per_level' do
    ...
    context 'with an intelligence of 15' do
      ...
      it { expect(subject.skills_per_level).to eql 8 }
    end

    context 'with an intelligence of 27' do
      let(:intelligence) { 27 }

      it { expect(subject.skills_per_level).to eql 14 }
    end
  end

  describe '.hit_die' do
    it { expect(described_class.hit_die).to eql 10 }
  end

  describe '#hit_die' do
    it { expect(subject.hit_die).to eql 10 }
  end
  ...
  describe '#base_attack_bonus' do
    ...
    context 'at level 1' do
      ...
      it { expect(subject.base_attack_bonus).to eql 1 }
      it { expect(subject.base_attack_bonus(1)).to eql 1 }
    ...
    context 'at level 5' do
      ...
      it { expect(subject.base_attack_bonus).to eql 5 }
      it { expect(subject.base_attack_bonus(1)).to eql 5 }
      it { expect(subject.base_attack_bonus(2)).to eql 0 }
    end
    ...
    context 'at level 10' do
      ...
      it { expect(subject.base_attack_bonus).to eql 10 }
      it { expect(subject.base_attack_bonus(1)).to eql 10 }
      it { expect(subject.base_attack_bonus(2)).to eql 5 }
    ...
    context 'at level 20' do
      ...
      it { expect(subject.base_attack_bonus).to eql 20 }
      it { expect(subject.base_attack_bonus(1)).to eql 20 }
      it { expect(subject.base_attack_bonus(2)).to eql 15 }
      it { expect(subject.base_attack_bonus(3)).to eql 10 }
      it { expect(subject.base_attack_bonus(4)).to eql 5 }
      it { expect(subject.base_attack_bonus(5)).to eql 0 }
    end
  end
  ...
  describe '#available_attacks' do
    ...
    context 'at level 20' do
      ...
      it { expect(subject.available_attacks).to eql 4 }
    end
  end
  ...
  describe '#will_save_base' do
    context 'at level 1' do
      ...
      it { expect(subject.will_save_base).to eql 0 }
    end

    context 'at level 5' do
      let(:level) { 5 }

      it { expect(subject.will_save_base).to eql 1 }
    end

    context 'at level 10' do
      let(:level) { 10 }

      it { expect(subject.will_save_base).to eql 3 }
    end

    context 'at level 15' do
      let(:level) { 15 }

      it { expect(subject.will_save_base).to eql 5 }
    end

    context 'at level 20' do
      let(:level) { 20 }

      it { expect(subject.will_save_base).to eql 6 }
    end
  end
end
