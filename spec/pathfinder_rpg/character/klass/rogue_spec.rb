RSpec.describe PathfinderRpg::Character::Klass::Rogue do
  ...
  describe '.label' do
    it { expect(described_class.label).to eql 'rogue' }
  end

  describe '#label' do
    it { expect(subject.label).to eql 'rogue' }
  end
  ...
  describe '.skill_ranks_per_level' do
    it { expect(described_class.skill_ranks_per_level).to eql 8 }
  end

  describe '#skill_ranks_per_level' do
    it { expect(subject.skill_ranks_per_level).to eql 8 }
  end
  ...
  describe '#skills_per_level' do
    ...
    context 'with an intelligence of 27' do
      ...
      it { expect(subject.skills_per_level).to eql 16 }
    end
  end
